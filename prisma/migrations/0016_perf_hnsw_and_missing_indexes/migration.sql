...
DROP INDEX IF EXISTS "DocumentChunk_embedding_cosine_idx";
...
CREATE INDEX IF NOT EXISTS "Business_category_province_idx"
...
CREATE INDEX IF NOT EXISTS "Event_reminder_filter_idx"
...
CREATE INDEX IF NOT EXISTS "LoyaltyTransaction_expiry_scan_idx"
