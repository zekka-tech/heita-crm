...
Loyalty transaction errors are elevated.

## First checks

1. Open the Grafana SLO overview dashboard and confirm whether this is isolated or part of a wider incident.
2. Check earn/redeem routes, Prisma errors, transaction conflicts, and recent loyalty-rule changes.
