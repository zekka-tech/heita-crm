...
Webhook signature/shared-secret failures are elevated.

## First checks

1. Open the Grafana SLO overview dashboard and confirm whether this is isolated or part of a wider incident.
2. Confirm provider secrets, replay windows, source IPs, and whether traffic is forged or a secret was rotated.
