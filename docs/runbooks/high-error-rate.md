...
HTTP 5xx rate is above the critical threshold.

## First checks

1. Open the Grafana SLO overview dashboard and confirm whether this is isolated or part of a wider incident.
2. Check recent deploys, database health, upstream provider errors, and top 5xx routes in the HTTP RED dashboard.
