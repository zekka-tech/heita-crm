...
Webhook ingestion SLO is burning budget fast.

## First checks

1. Open the Grafana SLO overview dashboard and confirm whether this is isolated or part of a wider incident.
2. Page on-call; protect inbound WhatsApp/Africa's Talking ingestion and replay safely.
